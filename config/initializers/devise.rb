...
Devise.setup do |config|
  ...
  # config.secret_key = 'ff903c6f13d255c1514ce739e73ee1fc8611cfaa4d6d8eb3d0d9317be91b91d05595e2f2272ef788df7830e6eb25e29b163a9ee297755be90d206deeba6de788'
  ...
  config.mailer_sender = "no-reply@#{Rails.configuration.host}"
  ...
  config.case_insensitive_keys = %i[name email]

  # Configure which authentication keys should have whitespace stripped.
  # These keys will have whitespace before and after removed upon creating or
  # modifying a user and when used to authenticate or find a user. Default is :email.
  config.strip_whitespace_keys = %i[name email]
  ...
  config.http_authentication_realm = 'Soundstorm'
  ...
  # config.pepper = '58de936c423bcdbd1a476ae93084f76e90fce90bc4e8eb4680324d013b5f03ef996dd4252bb3795cd17c3672552d8baab646a7fec73e675771a6a98ddb40dd9c'
