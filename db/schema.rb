...
ActiveRecord::Schema.define(version: 20_181_124_070_020) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.index %w[likeable_id likeable_type], name: 'fk_likeables'
    t.index %w[liker_id liker_type], name: 'fk_likes'
  end
  ...
  create_table 'mentions', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.index %w[mentionable_id mentionable_type], name: 'fk_mentionables'
    t.index %w[mentioner_id mentioner_type], name: 'fk_mentions'
  end
